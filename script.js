document.getElementById('question1').addEventListener('submit', function(event) {
    ...
    document.getElementById('result1').textContent = conf1;
});

document.getElementById('question2').addEventListener('submit', function(event) {
    event.preventDefault();

    var res1 = Number(document.getElementById('res2').value);
    ...
    document.getElementById('result2').textContent = conf1;
});

document.getElementById('question3').addEventListener('submit', function(event) {
    event.preventDefault();

    var res1 = Number(document.getElementById('res3').value);
    ...
    document.getElementById('result3').textContent = conf1;
});

document.getElementById('question4').addEventListener('submit', function(event) {
    event.preventDefault();

    var res1 = Number(document.getElementById('res4').value);
    ...
    document.getElementById('result4').textContent = conf1;
});

document.getElementById('question5').addEventListener('submit', function(event) {
    event.preventDefault();

    var res1 = Number(document.getElementById('res5').value);
...
function showResult(){
    ...
    if (userScore > 3){
        ...
        let scoreTag = '<span>Poderia ter ido melhor 😐, Você tem <p>'+ userScore +'</p> de <p>'+ questions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;
    }
}
